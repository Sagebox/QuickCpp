// ----------------------------------------------------------------------
// Sagebox Quick C++ -- Mouse Movement and Basic Events (Windows Version)
// ----------------------------------------------------------------------
//
...
// 
// This is the Windows-only version of this example.  It is a Pure Windows program without a console-mode window.
// It uses the WinMain.Lib library to transfer control from WinMain() to main() automatically.
...
int main()
{
    ...
    while(win.GetEvent())
    {
        ...
        if (win.MouseMoved(pMouse)) 
        {
            ...
            debug.printf("Mouse Moved at {g}(%d,%d)\n",pMouse.x,pMouse.y); 
        }
