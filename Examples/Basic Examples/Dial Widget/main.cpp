...
// -------------------------------------
// Sagebox Quick C++ Dial Widget Example
// -------------------------------------
//
...
//
// Note: See the LCD Widget example for a Widget example that includes the Widget library as part of the 
//       project and not as part of the source (i.e. "#pragma" inclusion), as shown below. 
