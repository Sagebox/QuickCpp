...
int main()
{
  ...
  //  CSageBox cSageBox("Multiple Color Widget Example with the Color Wheel Widget");
    ...
    CColorWheelWidget cColor1(win.GetWindow(),iX + 620,iY + 220*0,Transparent()); 
    CColorWheelWidget cColor2(win.GetWindow(),iX + 620,iY + 220*1,Transparent());
    ...
    while(win.GetEvent())
    {
        ...
        win.DrawGradient(iX,iY,600,600,rgbColor1,rgbBlack);
        win.DrawGradient(iX+100,iY+100,400,400,rgbBlack,rgbColor2);
