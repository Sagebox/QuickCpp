...
#if !defined(_CDavListBox_H_)
#define _CDavListBox_H_
#include "CDavinci.h"
#include "CListBoxHandler.h"
...
kAdvPublic:		// Public or --Adanced define
	...
	CListBox(const CListBox &p);						// Copy constructor to force error on copy (since its a managed object)

public:
	static void deleteObj(CListBox * p) 
	{ 
		delete p; 
	}
private:
