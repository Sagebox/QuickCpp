...
public:
    ...
    operator CWindow * () { return GetWindow(); }
    ...
    static bool DrawPolygon(POINT * pPoints,int iVertices,RGBColor_t rgbColor = Rgb::Default,RGBColor_t rgbColorOut = Rgb::Undefined);

    //-->  Original Prototype: bool DrawOpenPolygon(POINT * pPoints,int iVertices,int iColor1,int iPenSize = 0);

    static bool DrawOpenPolygon(POINT * pPoints,int iVertices,int iColor1,int iPenSize = 0);

    //-->  Original Prototype: bool DrawOpenPolygon(POINT * pPoints,int iVertices,RGBColor_t rgbColor = Rgb::Default,int iPenSize = 0);

    static bool DrawOpenPolygon(POINT * pPoints,int iVertices,RGBColor_t rgbColor = Rgb::Default,int iPenSize = 0);
  ...
  // Return a CWindow & for a Window with a Name or an ID. 
    ...
    // a false return. 
    //
    static bool DisplayBitmap(POINT pLoc,RawBitmap_t & stBitmap);
    ...
    // See DisplayBitmap() for more details on this function.
    //
    static bool DisplayBitmapR(int iX,int iY,RawBitmap32_t & stBitmap);
    ...
    // See DisplayBitmap() for more details on this function.
    //
    static bool DisplayBitmapR(POINT pLoc,RawBitmap32_t & stBitmap);
    ...
    // See DisplayBitmap() for more details on this function.
    //
    static bool DisplayBitmapR(RawBitmap32_t & stBitmap);
    ...
    static bool StretchBitmap32(unsigned char * sMemory,POINT pDest,SIZE szDest,POINT pSrc,SIZE szSource,SIZE szSourceBitmap = {0,0});

    //-->  Original Prototype: bool StretchBitmap32(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest);

    static bool StretchBitmap32(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest);

    //-->  Original Prototype: bool StretchBitmap32(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest,POINT pSrc, SIZE szSource);

    static bool StretchBitmap32(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest,POINT pSrc,SIZE szSource);
    ...
    static bool StretchBitmap32R(unsigned char * sMemory,POINT pDest,SIZE szDest,POINT pSrc,SIZE szSource,SIZE szSourceBitmap = {0,0});

    //-->  Original Prototype: bool StretchBitmap32R(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest);

    static bool StretchBitmap32R(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest);

    //-->  Original Prototype: bool StretchBitmap32R(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest,POINT pSrc, SIZE szSource);

    static bool StretchBitmap32R(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest,POINT pSrc,SIZE szSource);

    //-->  Original Prototype: bool StretchBitmap(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest);

    static bool StretchBitmap(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest);

    //-->  Original Prototype: bool StretchBitmap(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest,POINT pSrc, SIZE szSource);

    static bool StretchBitmap(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest,POINT pSrc,SIZE szSource);

    //-->  Original Prototype: bool StretchBitmapR(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest);

    static bool StretchBitmapR(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest);

    //-->  Original Prototype: bool StretchBitmapR(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest,POINT pSrc, SIZE szSource);

    static bool StretchBitmapR(RawBitmap32_t & cBitmap,POINT pDest,SIZE szDest,POINT pSrc,SIZE szSource);
   ...
   // MouseClicked() -- returns true if the Left Mouse Button was clicked.
    ...
    static bool StartMouseDrag(POINT pPoint);
    ...
    /// </summary>
    /// <returns></returns>
    static HBITMAP GetBitmapHandle();
   ...
   /// <summary>
    ...
    //
    static bool CaptureMouse(bool bReleaseOnMouseUp = true);
    ...
    //-->  Original Prototype: RawBitmap32_t ReadImageFile32(const char * sPath,bool * bSuccess = nullptr);

    [[nodiscard]] static RawBitmap32_t ReadImageFile32(const char * sPath,bool * bSuccess = nullptr);
    ...
    /// <param name="bSuccess">(optional) filled with true/false if image was read successfully.</param>
    /// <returns></returns>
    static CBitmap ReadImageMem(const unsigned char * sMem,size_t tMemLength,bool * bSuccess = nullptr);
    ...
    /// <param name="bSuccess">(optional) filled with true/false if image was read successfully.</param>
    /// <returns></returns>
    static CBitmap ReadImageMem(Mem<unsigned char> & cMem,bool * bSuccess = nullptr);
    ...
    /// <param name="bSuccess">(optional) filled with true/false if image was read successfully.</param>
    /// <returns></returns>
    static CBitmap ReadImageMem(std::vector<unsigned char> & vMem,bool * bSuccess = nullptr);
    ...
    static CListBox & NewListBox(int ix,int iy,int iWidth,int iHeight,const char * sItemList,const cwfOpt & cwOpt = cwfOpt());
    ...
    static CListBox & NewListBox(CListBox * cListBox,int ix,int iy,int iWidth,int iHeight,const char * sItemList,const cwfOpt & cwOpt = cwfOpt());

    //-->  Original Prototype: CComboBox &  NewComboBox(int iX,int iY,int iWidth,const cwfOpt & cwOpt = cwfOpt());

    static CComboBox & NewComboBox(int iX,int iY,int iWidth,const cwfOpt & cwOpt = cwfOpt());

    //-->  Original Prototype: CComboBox &  NewComboBox(int iX,int iY,int iWidth,const char * sItemList,const cwfOpt & cwOpt = cwfOpt());

    static CComboBox & NewComboBox(int iX,int iY,int iWidth,const char * sItemList,const cwfOpt & cwOpt = cwfOpt());

    //-->  Original Prototype: CComboBox &  NewComboBox(CComboBox * cComboBox,int iX,int iY,int iWidth,const cwfOpt & cwOpt = cwfOpt());

    static CComboBox & NewComboBox(CComboBox * cComboBox,int iX,int iY,int iWidth,const cwfOpt & cwOpt = cwfOpt());
    ...
    static CComboBox & NewComboBox(CComboBox * cComboBox,int iX,int iY,int iWidth,const char * sItemList,const cwfOpt & cwOpt = cwfOpt());
    ...
    static CComboBox & DevComboBox(const cwfOpt & cwOpt = cwfOpt());
    ...
    //-->  Original Prototype: bool DevWindowAutoHide(bool bAutoHide = true,bool bAddCloseButton = false);
    ...
    /// <returns></returns>
    static bool DevWindowAutoHide(bool bAutoHide = true,bool bAddCloseButton = false);

    //-->  Original Prototype: bool DevWindowShow(bool bShow = true);
    ...
    /// <returns></returns>
    static bool DevWindowShow(bool bShow = true);

    //-->  Original Prototype: bool DevWindowHide(bool bHide = true);
    ...
    /// <returns></returns>
    static bool DevWindowHide(bool bHide = true);

    //-->  Original Prototype: bool DevWindowCloseEvent(bool bAddCloseButton = false);
    ...
    /// <param name="bAddCloseButton"> -- True to create a close button.  Otherwise only the 'x' appears in the upper-right corner.</param>
    /// <returns></returns>
    static bool DevWindowCloseEvent(bool bAddCloseButton = false);

    //-->  Original Prototype: bool DevAllowClose(bool bAddCloseButton = false);
    ...
    /// <returns></returns>
    static bool DevAllowClose(bool bAddCloseButton = false);

    //-->  Original Prototype: bool DevWindowClosed(bool bAddCloseButton = false);
    ...
    /// <returns>true if the user has attempted to close the window.</returns>
    static bool DevWindowClosed(bool bAddCloseButton = false);
    ...
    //-->  Original Prototype: bool DevWaitEvent(bool bReturnFalseOnClose = true);
    ...
    /// <returns></returns>
    static bool DevWaitEvent(bool bReturnFalseOnClose = true);
    ...
    static Gdiplus::Graphics & GetGdiGraphics();
    ...
    /// <returns></returns>
    static bool VsyncReady(Peek peek = Peek::No);
    ...
    public:
     ...
     // static CSagebox cSageboxX; $$ We don't need this any more, but this is still here to keep track of changes    
     //                               (it may also return; the current code may only be a work-around)
     //                               This revolves around getting StaticSagebox more permanently configured after the Alpha version moves into a Beta
     //                               Note: this was removed because of initilization ordering issues that can't be controlled; 
     //                               items needed (in the Sage namespace) were suddenly getting initialized after cSageboxX above, which 
     //                               required those items.  The Quick C++ methodology currently relies on a Global Sagebox object, so it now refers to 
     //                               the private one created by calling Sagebox::GetStaticSagebox() rather than the one above -- though this may change.
        static CWindow * cWin;
    };
